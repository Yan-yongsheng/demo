<template lang="">
    <div>
        <el-container>
            ...
            <el-main>
                <el-button type="danger" style="top: 8px;left: 250px;position: absolute;" @click="dialogVisible=true"
                    plain round>
                    机构推荐
                </el-button>
                <el-dialog v-model="dialogVisible" title="为您推荐以下机构：" width="30%">
                    <div>上海华测品标检测技术有限公司</div>
                    <br>
                    <div>中钢集团郑州金属制品研究院股份有限公司</div>
                    <br>
                    <div>优尔鸿信检测技术（深圳）有限公司</div>
                    <br>
                    <div>SGS通标标准技术服务有限公司</div>
                    <br>
                    <div>青岛江河检测有限公司</div>
                </el-dialog>
